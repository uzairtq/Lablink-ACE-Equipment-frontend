...
class layout extends React.Component {
    ...
    handleProfileMenuClick = event => {
        this.setState({ profileMenuAnchor: event.currentTarget, profileMenuOpen: true });
    }
    ...
    render() {
        let userManager = (
            <Button color='inherit' component={navItems.login} >Sign In</Button>
        )
            ...
            <div className={this.props.classes.root}>
                ...
                <MuiThemeProvider theme={theme}>
                    ...
                    <Drawer variant='permanent' className={this.props.classes.drawer} classes={{ paper: this.props.classes.drawerPaper }}>
                        ...
                        <List>
                            <ListItem button component={navItems.samples} key='samples'>
