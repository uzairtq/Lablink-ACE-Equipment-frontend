                ...
                <TableBody>
                    {props.sampleList.map(sample => (
                        <TableRow hover key={sample.id}>
                            ...
                            <TableCell>{sample.hasOwnProperty('owner') ? sample.owner : ''}</TableCell>
                            <TableCell>{sample.hasOwnProperty('owner') ? sample.assignee : ''}</TableCell>
                            <TableCell align='right'>
                                <Button variant="outlined" size="small" onClick={() => props.onEditSample(sample)}>Edit</Button>
                                <IconButton
                                    color='inherit'
